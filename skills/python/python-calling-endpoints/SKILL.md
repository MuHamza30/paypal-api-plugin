...
`BaseController`. `doc/client.md` lists every controller property and the class it returns; each
`doc/controllers/*.md` page then lists that controller's operations, their parameters, the response type
