...
2. Open the matching page under `doc/auth/` for the credential names, the client kwarg, and a
   ready-made snippet. Custom authentication is the only scheme with no page — open its module under
   `http/auth/` instead.
